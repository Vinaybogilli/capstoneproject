...
import com.vinay.wipro.service.AccountService;
...
public class AccountController {
	...
	public ResponseEntity<Void> updateAccountBalance(@PathVariable String accountNumber, @PathVariable Long balance){
	...
	public ResponseEntity<List<Account>> getAllAccounts(){
	 ...
	 @GetMapping("/getCustomerId/{accountNumber}")
	   public ResponseEntity<Long> getCustomerId(@PathVariable String accountNumber) {
		 Long id=accountService.getCustomerId(accountNumber);
